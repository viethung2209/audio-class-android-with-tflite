...
public final class ControlsBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final RadioButton robotCommand;
  ...
  private ControlsBottomSheetBinding(@NonNull NestedScrollView rootView,
      ...
      @NonNull RadioButton robotCommand, @NonNull RadioButton speechCommand,
      @NonNull AppCompatSpinner spinnerDelegate, @NonNull AppCompatSpinner spinnerOverlap,
  ...
  public static ControlsBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.robot_command;
      RadioButton robotCommand = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ControlsBottomSheetBinding((NestedScrollView) rootView, audioContainer,
          ...
          resultsPlus, resultsValue, robotCommand, speechCommand, spinnerDelegate, spinnerOverlap,
